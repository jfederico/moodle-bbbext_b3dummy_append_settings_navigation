 ...
 *
 * @package   bbbext_b3dummy_append_settings_navigation
 ...
 */
function b3dummy_append_settings_navigation_append_extend_settings_navigation(settings_navigation $settingsnav, navigation_node $nodenav) {
    // Get Course Module.
    ...
    $nodenav->add(get_string('completionvalidatestate', 'bigbluebuttonbn') . ' customized by append',
