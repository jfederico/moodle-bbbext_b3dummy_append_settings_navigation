...
namespace bbbext_b3dummy_append_settings_navigation\bigbluebuttonbn;
...
class navigation_append_addon implements navigation_append_addon_interface {
    ...
    public function append_settings_navigation(\settings_navigation $settingsnav, \navigation_node $nodenav): void {
        $nodenav->add(
            get_string('b3dummy_append_settings_navigation', 'bbbext_b3dummy_append_settings_navigation'),
            new \moodle_url('#'),
            \navigation_node::TYPE_SETTING,
            null,
            'b3dummy_append_settings_navigation'
        );
    }
}
